        ...
        while (true) {
            if (message.startsWith(AUTH_CMD_PREFIX)) {
                ...
                if (username != null) {
                    ...
                    myServer.broadcastMessage(String.format(">>> %s среди нас, успешно подключился", username), this, true);
...
//            System.out.println("log (readMessage)");
    ...
    public void sendMessage(String sender, String message) throws IOException {
        if (sender == null) {
            ...
            // Upgrade для /w
            // out.writeUTF(String.format("%s %s %s %s", CLIENT_MSG_PREFIX, sender, message, destinationHandler));
        }
    }
