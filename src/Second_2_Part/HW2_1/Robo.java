...
public class Robo implements Run, Jump {

    private Integer id;
    private String name;
    private final String defaultName = "some robo";
    private int maxRunDistance;
    private int maxJumpHeight;
    private boolean success;

    Robo(String name, int maxRunDistance, int maxJumpHeight) {
        setName(name);
    ...
    public String getName() {
        System.out.println("Робота зовут " + this.name);
        return name;
    }
